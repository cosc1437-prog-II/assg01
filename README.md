...
Your new repository on GitHub will be named something like `assg01-username`
...
the `assg01` folder if it is not currently open.  Then perform a `make
...
command palette.  Keyboard shortcuts may or may not already be assigned to
...
rm -rf  obj/assg01-tests.o  obj/primes.o  obj/assg01-sim.o  obj/primes.o
```
- `ctrl-shift-b`  make build
```
> Executing task: make all <
mkdir -p obj
g++ -Wall -Werror -pedantic -g -Iinclude -c src/assg01-tests.cpp -o obj/assg01-tests.o
...
g++ -Wall -Werror -pedantic -g  obj/assg01-tests.o  obj/primes.o obj/catch2-main.o  -o test
g++ -Wall -Werror -pedantic -g -Iinclude -c src/assg01-sim.cpp -o obj/assg01-sim.o
g++ -Wall -Werror -pedantic -g  obj/assg01-sim.o  obj/primes.o  -o sim
```
...
|------------------------|-----------------------------------------------------------------------------|
| `src/assg01-tests.cpp` | Unit tests for the two functions  you are to write.                         |
| `src/assg01-sim.cpp`   | The `main()` function for the assignment command line simulation.           |
...
`assg01-tests.cpp`.  Some or all of these tests will be commented out
...
Once you have the Task 1 issue created, open up the `assg01-tests.cpp`
...
g++ -Wall -Werror -pedantic -g -Iinclude -c src/assg01-tests.cpp -o obj/assg01-tests.o
In file included from src/assg01-tests.cpp:22:
src/assg01-tests.cpp: In function ‘void C_A_T_C_H_T_E_S_T_0()’:
src/assg01-tests.cpp:41:9: error: ‘isPrime’ was not declared in this scope
   41 |   CHECK(isPrime(1));
      |         ^~~~~~~
In file included from src/assg01-tests.cpp:22:
src/assg01-tests.cpp:41:9: error: ‘isPrime’ was not declared in this scope
   41 |   CHECK(isPrime(1));
      |         ^~~~~~~
make: *** [include/Makefile.inc:63: obj/assg01-tests.o] Error 1
```
...
g++ -Wall -Werror -pedantic -g -Iinclude -c src/primes.cpp -o obj/primes.o
g++ -Wall -Werror -pedantic -g  obj/assg01-tests.o  obj/primes.o obj/catch2-main.o  -o test
/usr/bin/ld: obj/assg01-tests.o: in function `C_A_T_C_H_T_E_S_T_0()':
/workspaces/assg01-tamuc-student-team/src/assg01-tests.cpp:41: undefined reference to `isPrime(int)'
/usr/bin/ld: /workspaces/assg01-tamuc-student-team/src/assg01-tests.cpp:42: undefined reference to `isPrime(int)'
/usr/bin/ld: /workspaces/assg01-tamuc-student-team/src/assg01-tests.cpp:43: undefined reference to `isPrime(int)'
/usr/bin/ld: /workspaces/assg01-tamuc-student-team/src/assg01-tests.cpp:46: undefined reference to `isPrime(int)'
/usr/bin/ld: /workspaces/assg01-tamuc-student-team/src/assg01-tests.cpp:49: undefined reference to `isPrime(int)'
/usr/bin/ld: obj/assg01-tests.o:/workspaces/assg01-tamuc-student-team/src/assg01-tests.cpp:50: more undefined references to `isPrime(int)' follow
...
The `assg01-tests.cpp` file actually compiles successfully now.  This is because it includes
the signature you added from `primes.hpp` header file, and so the `c++` compiler
knows how to compile the test into an object file named `assg01-tests.o`. 
...
If you look closely back at the `assg01-tests.cpp` file, you will
...
in `assg01-tests.cpp`.  You should try building your code now.  You
